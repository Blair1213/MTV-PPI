...
AllEdge = []
ReadMyCsv(AllEdge, "LPLncRNA2TargetLncProtein3.csv")  #lncRNA,disease
...
StorFile(AllEdgeNum, 'LncAndProtein.csv')

# 生成AllLncNum，AllMiNum
# 生成AllLncNum，AllMiNum


AlllncNum = Tool.GenerateAllDrug(AllEdgeNum)  #0
AllDiseaseNum = Tool.GenerateAllDisease(AllEdgeNum)   #1


Tool.StorFile(AllDiseaseNum, 'AllProteinNum.csv')
