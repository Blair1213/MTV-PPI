...
while counter < 10:
    AllNodeFeatureNum = []
    AllNodeFeatureNumName = 'AllNodeAttributeMannerNum' + str(counter//2) + '.csv'
    ...
    while counter1 < len(PositiveSample):
        FeaturePair = []
        #FeaturePair.extend(AllNodeFeatureNum[np.where(AllNodeFeatureNumP[:, 0] == PositiveSample[counter1][0])[0][0]])
        #FeaturePair.extend(AllNodeFeatureNum[np.where(AllNodeFeatureNumP[:, 0] == PositiveSample[counter1][1])[0][0]])
