...
FinalLncFeatureNum = []
ReadMyCsv(FinalLncFeatureNum, 'FinalLncKmerNum.csv')

FinalDiseaseFeatureNum = []
ReadMyCsv(FinalDiseaseFeatureNum, 'FinalProteinNum.csv')
...
while counterP < 5:
    ...
    while counter < len(FinalLncFeatureNum):
        AllNodeMannerNum[int(FinalLncFeatureNum[counter][0])].extend(FinalLncFeatureNum[counter][1:])
        num1 = num1 + 1
        counter = counter + 1
    print(num1)
